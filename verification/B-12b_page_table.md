...
| the window answers `camera.set_property` | a sentence | a sentence | pass |
...
| the window answers `layer.set_depth` | a sentence | a sentence | pass |
