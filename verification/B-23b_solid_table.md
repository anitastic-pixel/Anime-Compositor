...
| Check | The build's answer | Matches |
| --- | --- | --- |
| FX-SOL-020: A solid that names an asset. | ProjectSchemaInvalid: At /compositions/0/layers/0/asset_id: expected no asset_id on an adjustment, composition or solid layer, which has no drawing (D-66, D-67, D-74). | yes |
