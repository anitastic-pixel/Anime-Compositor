...
| matte: undoing the delete restores the target and the dependent exactly | `Layer { id: Id("layer-fx"), name: "fx", kind: Raster, asset_id: Id("asset-effects"), composition_id: None, enabled: true, locked: false, in_frame: 0, out_frame: 240, source_offset_frames: 0, transform: Transform { anchor: Property { base: Vec2(0.0, 0.0), keyframes: [], expression: None, split: None }, position: Property { base: Vec2(0.0, 0.0), keyframes: [], expression: None, split: None }, scale: Property { base: Vec2(1.0, 1.0), keyframes: [], expression: None, split: None }, rotation: Property { base: Scalar(0.0), keyframes: [], expression: None, split: None }, opacity: Property { base: Scalar(1.0), keyframes: [], expression: None, split: None } }, exposure_spans: [], masks: [], matte: Some(MatteReference { layer_id: Id("layer-3"), matte_only: false }), parent: None, effects: [], blend_mode: Normal, label: 0, shy: false, depth: None, gain_db: 0.0, solid: None, shapes: [], timesheet: None }` | `Layer { id: Id("layer-fx"), name: "fx", kind: Raster, asset_id: Id("asset-effects"), composition_id: None, enabled: true, locked: false, in_frame: 0, out_frame: 240, source_offset_frames: 0, transform: Transform { anchor: Property { base: Vec2(0.0, 0.0), keyframes: [], expression: None, split: None }, position: Property { base: Vec2(0.0, 0.0), keyframes: [], expression: None, split: None }, scale: Property { base: Vec2(1.0, 1.0), keyframes: [], expression: None, split: None }, rotation: Property { base: Scalar(0.0), keyframes: [], expression: None, split: None }, opacity: Property { base: Scalar(1.0), keyframes: [], expression: None, split: None } }, exposure_spans: [], masks: [], matte: Some(MatteReference { layer_id: Id("layer-3"), matte_only: false }), parent: None, effects: [], blend_mode: Normal, label: 0, shy: false, depth: None, gain_db: 0.0, solid: None, shapes: [], timesheet: None }` | PASS |
