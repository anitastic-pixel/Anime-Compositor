...
5. **Scrub and play at Full.** Switch to **Full resolution** and do the same. Play the shot twice. Since B-44b the second time should be smoother on GPU than on CPU, though effects still run on the CPU (`B-44b_gpu_uploads.md`).
