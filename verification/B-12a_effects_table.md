...
The picture. These rows check what the panel does to the project, not what the renderer then draws; the blur, exposure and tint themselves are checked against independently generated weights in `verification/B-07_effect_table.md`, and the frame with an effect on it is in the photographs beside this table.
