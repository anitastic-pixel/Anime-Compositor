...
| the Sheet, whose cells take typing (D-84b) is put into the Tab order by hand | true | true | pass |
...
| `memory` can be asked for without a mouse | yes | yes | pass |
