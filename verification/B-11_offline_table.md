...
| and that part's whole dependency list is small enough to read | adler2, bit_field, bitflags, bytemuck, cfg-if, crc32fast, crossbeam-deque, crossbeam-epoch, crossbeam-utils, either, exr, fdeflate, flate2, half, itoa, lebe, libm, memchr, miniz_oxide, num-complex, num-traits, paste, png, proc-macro2, pulp, pulp-wasm-simd-flag, quote, raw-cpuid, rayon, rayon-core, reborrow, serde_core, serde_json, simd-adler32, smallvec, syn, unicode-ident, zerocopy, zerocopy-derive, zlib-rs, zmij, zune-inflate | adler2, bit_field, bitflags, bytemuck, cfg-if, crc32fast, crossbeam-deque, crossbeam-epoch, crossbeam-utils, either, exr, fdeflate, flate2, half, itoa, lebe, libm, memchr, miniz_oxide, num-complex, num-traits, paste, png, proc-macro2, pulp, pulp-wasm-simd-flag, quote, raw-cpuid, rayon, rayon-core, reborrow, serde_core, serde_json, simd-adler32, smallvec, syn, unicode-ident, zerocopy, zerocopy-derive, zlib-rs, zmij, zune-inflate | pass |
