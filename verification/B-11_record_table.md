...
| the record marks as direct exactly the dependencies the manifests ask for | exr, png, rayon, serde_json, tauri, tauri-build, tauri-plugin-dialog | exr, png, rayon, serde_json, tauri, tauri-build, tauri-plugin-dialog | pass |
