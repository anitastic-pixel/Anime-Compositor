...
R-06b / R / Bounded preview cache: cache reusable frame results with correct invalidation and a memory ceiling, per document 27. Parked under D-12. Revisit trigger: measured preview latency on the reference shot that makes editing unpleasant, recorded with numbers rather than asserted.
