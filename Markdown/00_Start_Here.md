...
**G2 is passed, and G3 is entered for B-15 and B-16. The owner decided both on 2026-09-16** (D-60). Current work is B-15, collect and package (R-14). B-15a, the specification D-61 and its fixtures, is written and waits on the owner's acceptance. B-16, other formats, follows, EXR first.
